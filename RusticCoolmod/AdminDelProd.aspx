<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminDelProd.aspx.cs" Inherits="RusticCoolmod.AdminDelProd" %>
...
<head runat="server">
    ...
    <title>ELIMINAR PRODUCTO - RUSTIC HARDWARE</title>
</head>
<body style="background-image:url('Assets/warehouse.jpg'); background-attachment: fixed; background-size: cover;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="card-header" style="background-color:black; color:white">ELIMINAR PRODUCTOS</div>
        <div class="card-body text-center" style="background-color:lightgray">
                ...
                <br />
                <h4>Nombre:</h4>
                <asp:TextBox ID="TextBox1" Width="20%" style="display:block; margin : 0 auto; font-size:16px" Height="40px" runat="server" placeholder="Nombre..." ReadOnly="True"></asp:TextBox>
                
                <br />
                <br />
                <h4>Precio:</h4>
                <br />
                <asp:TextBox ID="TextBox2" Width="20%" style="display:block; margin : 0 auto; font-size:16px" Height="40px" runat="server" placeholder="Precio..." ReadOnly="True"></asp:TextBox>
                
                <br />
                <br />
                <h4>Fabricante:</h4>
                <br />
                <asp:TextBox ID="TextBox3" Width="20%" style="display:block; margin : 0 auto; font-size:16px" Height="40px" runat="server" placeholder="Fabricante..." ReadOnly="True"></asp:TextBox>
                <br />
                <br />
                <asp:Button class="btn btn-primary" ID="Button1" runat="server" Text="Borrar" Width="20%" OnClick="Button1_Click"/>
                <br />
                <br />
                <asp:Panel ID="Panel1" runat="server" style="width:25%; margin:0 auto" Visible="false">
                    <div class="alert alert-dismissible alert-success">
                        <button type="button" class="close" data-dismiss="alert">&times;</button>
                        Producto eliminado correctamente a la base de datos.
                    </div>
                </asp:Panel>
                <br />
        </div>
