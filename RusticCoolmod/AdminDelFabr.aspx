<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminDelFabr.aspx.cs" Inherits="RusticCoolmod.AdminDelFabr" %>
...
<head runat="server">
    ...
    <title>ELIMINAR FABRICANTE - RUSTIC HARDWARE</title>
</head>
<body style="background-image:url('Assets/fabrwall.jpg'); background-attachment: fixed; background-size: cover;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarColor02">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="#">Eliminar fabricante</a>
                </li>
            </ul>
        ...
        <div class="card-header" style="background-color:black; color:white">ELIMINAR FABRICANTES</div>
        <div class="card-body text-center" style="background-color:lightgray">
                ...
                <asp:Panel ID="Panel1" runat="server" style="width:25%; margin:0 auto" Visible="false">
                    <div class="alert alert-dismissible alert-success">
                        ...
                        Fabricante eliminado correctamente a la base de datos.
                    </div>
                </asp:Panel>
                <br />
        </div>
