<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminAddProducto.aspx.cs" Inherits="RusticCoolmod.AdminAddProducto" %>
...
<head runat="server">
    ...
    <title>AÑADIR PRODUCTO - RUSTIC HARDWARE</title>
</head>
<body style="background-image:url('Assets/warehouse.jpg'); background-attachment: fixed; background-size: cover;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarColor02">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="#">Insertar producto</a>
                </li>
                <li class="nav-item">
        ...
        <div class="card-header" style="background-color:black; color:white">INSERTAR PRODUCTOS</div>
        <div class="card-body text-center" style="background-color:lightgray">
                ...
                <br />
                <asp:TextBox ID="TextBox3" Width="20%" style="display:block; margin : 0 auto; font-size:16px" Height="40px" runat="server" placeholder="Precio..."></asp:TextBox>
                <asp:RequiredFieldValidator class="text-danger" runat="server" ErrorMessage="El precio es obligatorio." ControlToValidate="TextBox3" Display="Dynamic"></asp:RequiredFieldValidator>    
                <asp:CompareValidator ID="CompareValidator2" class="text-danger" Operator="GreaterThan" ValueToCompare="0"  runat="server" ErrorMessage="Precio no válido." Type="Double" ControlToValidate="TextBox3" Display="Dynamic"></asp:CompareValidator> 
                <br />
                <br />
                <h4>Elija el fabricante del producto:</h4>
                <br />
                <asp:DropDownList ID="DropDownList1" class="nav-link dropdown-toggle" Width="20%" style="margin: 0 auto" data-toggle="dropdown" role="button" runat="server"></asp:DropDownList>
                <br />
                <br />
                ...
                <asp:Panel ID="Panel1" runat="server" style="width:25%; margin:0 auto" Visible="false">
                    <div class="alert alert-dismissible alert-success">
                        ...
                        Producto añadido correctamente a la base de datos.
                    </div>
                </asp:Panel>
                <br />
        </div>
